...
use Nyza\Routes\CompanyRoutes;
use Nyza\Routes\WorkspaceRoutes;
use Nyza\Routes\ContactImportRoutes;
use Nyza\Routes\ContactRoutes;
use Nyza\Routes\ContentRoutes;
use Nyza\Routes\ContentPlanRoutes;
use Nyza\Routes\ListRoutes;
...
use Nyza\Routes\LegacyImportRoutes;
...
InternalShareRoutes::mount($app);
ShareRoutes::mount($app);
UploadLinkRoutes::mount($app);
ActivityRoutes::mount($app);
TaskRoutes::mount($app);
ContactRoutes::mount($app);
ContentRoutes::mount($app);
ContentPlanRoutes::mount($app);
ListRoutes::mount($app);
ContactImportRoutes::mount($app);
CalendarRoutes::mount($app);
CompanyRoutes::mount($app);
WorkspaceRoutes::mount($app);
